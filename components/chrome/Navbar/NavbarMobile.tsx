    ...
    <header className="sticky top-0 z-40 bg-bg/85 backdrop-blur-md border-b border-border transition-all">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 h-20 flex items-center justify-between">
        ...
        <button
          ...
          className="p-2 rounded-full text-ink hover:bg-surface transition-colors"
      ...
      {/* Mobile Nav Drawer */}
      {mobileMenuOpen && (
        <div className="bg-surface border-b border-border px-4 pt-2 pb-6 space-y-4 shadow-hover transition-all duration-200 ease-out">
